...
translations_home = {
    ...
    "howtouse_text": {
        "en": f"Click '{translations_base['nav_search']['en']}' button on the top to start using this corpus.",
        "ru": f"Нажмите на кнопку '{translations_base['nav_search']['ru']}' чтобы начать пользоваться корпусом."
    }
}
